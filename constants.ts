...
export const MOCK_CLIENTS: Client[] = [
  { id: '1', name: 'Antonio Silva', cpf: '123.456.789-00', phone: '(11) 98765-4321', city: 'São Paulo', state: 'SP', cnh: '12345678901', cnh_validade: '2023-10-25', status: 'active' },
  { id: '2', name: 'Maria Julia', cpf: '222.333.444-55', phone: '(21) 99999-8888', city: 'Rio de Janeiro', state: 'RJ', cnh: '98765432109', cnh_validade: '2026-05-12', status: 'active' },
  { id: '3', name: 'Roberto Carlos', cpf: '098.765.432-10', phone: '(31) 91234-5678', city: 'Belo Horizonte', state: 'MG', cnh: '45678912300', cnh_validade: '2025-08-20', status: 'active' },
  { id: '4', name: 'Fernanda Brandão', cpf: '555.666.777-88', phone: '(41) 99887-7665', city: 'Curitiba', state: 'PR', cnh: '11223344556', cnh_validade: '2023-11-18', status: 'active' },
];
